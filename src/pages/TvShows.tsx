...
const TvShows = () => {
  ...
  const featuredShows = tvShows.filter(show => show.isFeatured);
  const trendingShows = tvShows.filter(show => show.isTrending);
  ...
  const showsByGenre = genres.slice(1).reduce((acc, genre) => {
    acc[genre] = tvShows.filter(show => show.genre === genre);
    return acc;
  }, {} as Record<string, typeof tvShows>);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/tv-shows" className="text-blue-400">TV Shows</Link>
      ...
      <div className="pt-16">
        ...
        <div className="bg-gradient-to-r from-purple-900 to-pink-900 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-gray-300">Binge-watch your favorite series</p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* Search Results or All Shows */}
          {searchQuery || selectedGenre !== "All" ? (
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6">
                {searchQuery ? `Search Results (${filteredShows.length})` : selectedGenre}
              </h2>
            ...
            <>
              {/* Featured Shows */}
              <section className="mb-12">
                <h2 className="text-2xl font-bold mb-6">Featured TV Shows</h2>
                <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-4">
