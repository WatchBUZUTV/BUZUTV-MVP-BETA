...
const Index = () => {
  ...
  const moviesByGenre = genres.slice(1).reduce((acc, genre) => {
    acc[genre] = mockMovies.filter(movie => movie.genre === genre);
    return acc;
    ...
    <div className="min-h-screen bg-gray-900 text-white">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="relative group">
                <button className="hover:text-blue-400 transition-colors">Movies</button>
              </div>
              <div className="relative group">
                <button className="hover:text-blue-400 transition-colors">TV Shows</button>
              </div>
              <Link to="/" className="hover:text-blue-400 transition-colors">My List</Link>
            </div>
          ...
          <div className="md:hidden bg-gray-800 border-t border-gray-700">
            <div className="px-4 py-4 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Link to="/" className="block hover:text-blue-400 transition-colors">Movies</Link>
                <Link to="/" className="block hover:text-blue-400 transition-colors">TV Shows</Link>
                <Link to="/" className="block hover:text-blue-400 transition-colors">My List</Link>
      ...
      <div className="pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* Genre Sections */}
          {!searchQuery && Object.entries(moviesByGenre).map(([genre, movies]) => (
